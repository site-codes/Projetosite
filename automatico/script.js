...
async function openEpsIndex(event) {
  ...
  inputCapaPlayEp.value = "https://example.com/capaPlay.jpg"; // Valor predefinido
  ...
  inputCapaPauseEp.value = "https://example.com/capaPause.jpg"; // Valor predefinido
  ...
  inputLogoSite.value = "https://example.com/logo.png"; // Valor predefinido

  // Adiciona os inputs à div de grupo
...
seasonHeader.innerText = `Temporada ${String(seasonNumber).padStart(2, '0')} - Lançamento: ${formattedReleaseDate}`;
    ...
    <main class="main1">
      <div class="mains">
        ...
        <div class="moreiep">
          ...
          <a id="preview" onclick="playSoundSec()" href="${index === 0 ? '' : `${previousEpisodeDate}${titleEpCustom}-t${String(seasonNumber).padStart(2, '0')}-episodio${previousEpisode ? `${String(previousEpisode.episode_number).padStart(2, '0')}` : '00'}-${tipoCustom}.html`}"></a>
          <a id="next" onclick="playSoundSec()" href="${index === episodeData.episodes.length - 1 ? '' : `${nextEpisodeDate}${titleEpCustom}-t${String(seasonNumber).padStart(2, '0')}-episodio${nextEpisode ? `${String(nextEpisode.episode_number).padStart(2, '0')}` : '00'}-${tipoCustom}.html`}"></a>
      ...
      <div class="mainsb">
        ...
        <div class="buttonslink">
          ...
          <a href="${link1080pInput.value}" onclick="playSoundSec()"></a>
